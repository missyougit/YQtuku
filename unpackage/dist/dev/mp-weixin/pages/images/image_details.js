...
var _image_details = _interopRequireDefault(__webpack_require__(/*! ./pages/images/image_details.vue */ 37));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _image_details_vue_vue_type_template_id_7aaf5700___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./image_details.vue?vue&type=template&id=7aaf5700& */ 38);
/* harmony import */ var _image_details_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./image_details.vue?vue&type=script&lang=js& */ 40);
...
/* harmony import */ var _image_details_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./image_details.vue?vue&type=style&index=0&lang=scss& */ 42);
...

{
  ...
  onLoad: function onLoad(options) {var _this = this;
    ...
    var url = this.baseUrl + "/comments/getComments?pageNum=" + this.pageNum + "&pageSize=" + this.pageSize + '&imagesId=' + this.image.id;
  ...
  methods: {
    getComments: function getComments(url) {var _this3 = this;
      uni.request({
        url: url,
        success: function success(res) {var _res$data =
          ...
          if (status == 200) {
            _this3.pages = result.pages;
            _this3.total = result.total;
            if (_this3.pageNum == 1) {
              _this3.comments = result.list;
            } else {
              _this3.comments = [].concat(_toConsumableArray(_this3.comments), _toConsumableArray(result.list));
            }
            _this3.pageNum++;
          } else {
            uni.showToast({
    ...
    zhijiehuifu: function zhijiehuifu(targetCommentsId) {
      this.isFocus = true;
